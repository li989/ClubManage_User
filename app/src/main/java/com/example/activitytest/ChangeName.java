...
public class ChangeName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnexit=(Button)findViewById(R.id.button_change_name_exit) ;
        ...
        final EditText e=(EditText)findViewById(R.id.EditText_change_name_theme);
        final Intent inte=getIntent();
        e.setText(inte.getStringExtra("default"));
        Button btnsave=(Button)findViewById(R.id.TextView_change_name_button) ;
        btnsave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog alertDialog2 = new AlertDialog.Builder(ChangeName.this)
                        .setTitle("确认修改")
                        .setMessage("是否保存修改信息")
                                ...
                                new Thread(){
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            Beanuser.currentLoginUser.setC_name(e.getText().toString());
